...
const STYLE_CONFIG = {
  colors: {
    blue: {
      ...
      faded:
        'bg-n-brand/10 text-n-green-text hover:enabled:bg-n-brand/20 focus-visible:bg-n-brand/20 outline-transparent',
      outline: 'text-n-green-text outline-n-brand',
      ghost:
        'text-n-green-text hover:enabled:bg-n-alpha-2 focus-visible:bg-n-alpha-2 outline-transparent',
      link: 'text-n-green-text hover:enabled:underline focus-visible:underline outline-transparent',
    },
    ruby: {
      solid:
